/** Coverage donut — a green arc over a hairline track, with a hero figure in the centre. */
  ...
  return (
    <div className="relative flex items-center justify-center" style={{ width: size, height: size }}>
      <svg width={size} height={size}>
        <defs>
          <linearGradient id="donut-grad" x1="0" y1="0" x2="1" y2="1">
            ...
            <stop offset="100%" stopColor="#34A56B" />
          </linearGradient>
        </defs>
      ...
      <div className="absolute text-center">
        <div className="hero-num text-[24px] text-green-dark">{centerLabel}</div>
