/** Paired-overlap mark (#5) — two rounded squares (ink + Base blue) meeting: saver + protector. */
...
export function Wordmark({ size = 28 }: { size?: number }) {
  return (
    <div className="flex items-center gap-2.5">
      ...
      <span className="rounded bg-blue-50 px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-[#0052FF]">
        Base
      </span>
    </div>
  );
