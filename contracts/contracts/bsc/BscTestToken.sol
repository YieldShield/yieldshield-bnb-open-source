...
/// @notice Fixed-supply, valueless BSC Testnet demo token. Not a stock, claim, or redeemable dollar.
...
contract BscTestToken is ERC20 {
    error DemoChainOnly();
        ...
        ERC20(name_, symbol_)
    {
        ...
        if ((decimals_ != 6 && decimals_ != 18) || initialSupply == 0 || recipient == address(0)) {
