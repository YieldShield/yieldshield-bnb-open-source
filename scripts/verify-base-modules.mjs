...
writeFileSync(resolve(root,'contracts/config/base-module-verification.json'),JSON.stringify({verifiedAt:new Date().toISOString(),runtimeLimit:24576,initcodeLimit:49152,contracts:sizes},null,2)+'\n');
